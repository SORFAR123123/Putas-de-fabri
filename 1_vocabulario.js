...
'sub1_3': {
    ...
    'sub2_1': {
        // MAZOS NORMALES
        1: [
            { japones: '自慢', lectura: 'jiman', opciones: ['Alarde', 'Modestia', 'Crítica', 'Queja'], respuesta: 0 },
            { japones: '小説', lectura: 'shōsetsu', opciones: ['Novela', 'Poema', 'Ensayo', 'Artículo'], respuesta: 0 },
            { japones: '現代の', lectura: 'gendai no', opciones: ['Moderno/Contemporáneo', 'Antiguo', 'Futuro', 'Tradicional'], respuesta: 0 },
            { japones: '正社員', lectura: 'seishain', opciones: ['Empleado fijo', 'Temporal', 'Freelance', 'Desempleado'], respuesta: 0 },
            { japones: '通して', lectura: 'tōshite', opciones: ['A través de', 'Sin pasar por', 'Evitando', 'Ignorando'], respuesta: 0 },
            { japones: '疑問に思いました', lectura: 'gimon ni omoimashita', opciones: ['Me pregunté', 'Estaba seguro', 'No me importó', 'Olvidé'], respuesta: 0 },
            { japones: '共感できる', lectura: 'kyōkan dekiru', opciones: ['Puedo identificarme', 'No entiendo', 'Rechazo', 'Ignoro'], respuesta: 0 },
            { japones: '扱っている', lectura: 'atsukatte iru', opciones: ['Tratando/Abordando', 'Evitando', 'Ignorando', 'Simplificando'], respuesta: 0 },
            { japones: '挟まれ', lectura: 'hasamare', opciones: ['Atrapado entre', 'Liberado de', 'Separado de', 'Unido a'], respuesta: 0 },
    ...
    'sub2_2': {
        ...
        // MAZOS DIFÍCILES ESPECIALES - Subcontenedor 2.2
        'D1': [],
        'D2': []
    },
